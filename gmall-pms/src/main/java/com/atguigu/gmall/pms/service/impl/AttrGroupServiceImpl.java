...
public class AttrGroupServiceImpl extends ServiceImpl<AttrGroupMapper, AttrGroupEntity> implements AttrGroupService {
    ...
    @Override
    public List<AttrGroupEntity> queryGroupsWithAttrsByCid(Long gid) {
        List<AttrGroupEntity> groupEntities = list(new QueryWrapper<AttrGroupEntity>().eq("category_id", gid));
