...
public class SkuController {
    ...
    public ResponseVo<List<SkuEntity>> skuBySpuId(@PathVariable("spuId")Long spuId){
        List<SkuEntity> skuAll = skuService.list(new QueryWrapper<SkuEntity>().eq("spu_id",spuId));
        return ResponseVo.ok(skuAll);
    }
